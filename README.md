...
- however, one has to handle functions declared locally, that is, in saving evaluation of `y` into `funcImpl`, a `funcImpl` has to save the whole call stack. So, high-order functions will make the implementation more complicated
